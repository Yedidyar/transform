        ...
        if (
          ...
          if (-1 === v) {
            ...
            if (0 === u.children.length)
              ...
              g = {
                offset:
                  (S = u.children[u.children.length - 1]).offset + S.length,
                length: 0,
                content: "," + m
              };
            return i(e, g, o);
          ...
          if (void 0 !== n) {
            ...
            if (!o.isArrayInsertion && u.children.length > l) {
              ...
              var S,
                T = l > u.children.length ? u.children.length : l;
              g = {
                offset: (S = u.children[T - 1]).offset + S.length,
                length: 0,
                content: "," + m
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (function(e) {
        (e.create = function(e, t, n, o) {
          if (E.uinteger(e) && E.uinteger(t) && E.uinteger(n) && E.uinteger(o))
      ...
      (function(e) {
        (e.create = function(e, t, n, r) {
          ...
          (e.is = function(e) {
            var t = e;
            return (
              E.numberRange(t.red, 0, 1) &&
              E.numberRange(t.green, 0, 1) &&
              E.numberRange(t.blue, 0, 1) &&
      ...
      (function(e) {
        (e.create = function(e, t, n, r, o) {
          ...
          return (
            E.defined(n) && (i.startCharacter = n),
          ...
          (e.is = function(e) {
            var t = e;
            return (
              E.uinteger(t.startLine) &&
              E.uinteger(t.startLine) &&
              (E.undefined(t.startCharacter) || E.uinteger(t.startCharacter)) &&
        ...
        (e.create = function(e, t, n, r, o, i) {
          ...
          (e.is = function(e) {
            ...
            return (
              ...
              (E.integer(n.code) || E.string(n.code) || E.undefined(n.code)) &&
      ...
      (function(e) {
        (e.create = function(e, t) {
          ...
          (e.is = function(e) {
            var t = e;
            return (
              E.defined(t) && b.is(t.textDocument) && Array.isArray(t.edits)
            );
          });
      ...
      (function(e) {
        (e.create = function(e, t, n) {
          ...
          (e.is = function(e) {
            var t = e;
            return (
              t && E.string(t.newText) && o.is(t.insert) && o.is(t.replace)
            );
          });
        ...
        (e.create = function(e, t, n) {
          ...
          (e.is = function(e) {
            ...
            return (
              t &&
              E.string(t.title) &&
              (void 0 === t.diagnostics || E.typedArray(t.diagnostics, c.is)) &&
      ...
      (function(e) {
        (e.create = function(e, t) {
          ...
          (e.is = function(e) {
            var t = e;
            return (
              E.defined(t) && E.uinteger(t.tabSize) && E.boolean(t.insertSpaces)
            );
          });
...
!(function(e) {
  ...
  (function(e) {
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.repeat = t.convertSimple2RegExpPattern = t.endsWith = t.startsWith = void 0),
            ...
            if (
              (!n ||
                ("string" !== n.type &&
                  ...
                  "boolean" !== n.type &&
                  "null" !== n.type) ||
                ((s = n.offset + n.length), (u = n), (n = n.parent)),
              n)
            ) {
                  ...
                  if (h.node === n && !h.inverted && h.schema) {
                    if ("array" === n.type && h.schema.items)
                      if (Array.isArray(h.schema.items)) {
                        ...
                        this.addSchemaValueCompletions(h.schema.items, f, i, a);
                    if (void 0 !== c) {
                      var g = !1;
          ...
          470: e => {
            ...
            var r = {
              ...
              relative: function(e, n) {
                ...
                for (
                  var c = n.length - s, u = a < c ? a : c, l = -1, f = 0;
                  f <= u;
                  ++f
                ) {
                  if (f === u) {
        ...
        (e.prototype.resolveSchemaContent = function(e, t, n) {
          ...
          var c = this.contextService,
            u = function(e, t, n, r) {
              ...
              if (s)
                for (var c in s)
                  s.hasOwnProperty(c) && !e.hasOwnProperty(c) && (e[c] = s[c]);
              else
                o.push(
                  a(
      ...
      a = (function() {
        ...
        return (
          (e.prototype.findDocumentSymbols = function(e, t, o) {
            ...
            return (
              C && o && o.onResultLimitExceeded && o.onResultLimitExceeded(l), S
            );
          }),
          (e.prototype.findDocumentSymbols2 = function(e, t, o) {
                    ...
                    ? t.items.forEach(function(t, r) {
                        if (t)
                          if (u > 0) {
                            ...
                            n.push(c), C.push({ result: c.children, node: t });
                          } else T = !0;
                      })
                    : "object" === t.type &&
                      t.properties.forEach(function(t) {
            ...
            return (
              T && o && o.onResultLimitExceeded && o.onResultLimitExceeded(l), x
            );
          }),
...
!(function(e) {
  ...
  define("vs/language/json/languageFeatures", [
                  ...
                  s = o.items.map(function(e) {
                    ...
                    return (
                      ...
                      e.additionalTextEdits &&
                        (o.additionalTextEdits = e.additionalTextEdits.map(l)),
    ...
    var C = (function() {
      ...
      return (
        (e.prototype.provideFoldingRanges = function(e, t, o) {
          var i = e.uri;
  ...
  define("vs/language/json/tokenization", [
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.TOKEN_COMMENT_LINE = t.TOKEN_COMMENT_BLOCK = t.TOKEN_PROPERTY_NAME = t.TOKEN_VALUE_NUMBER = t.TOKEN_VALUE_STRING = t.TOKEN_VALUE_NULL = t.TOKEN_VALUE_BOOLEAN = t.TOKEN_DELIM_COMMA = t.TOKEN_DELIM_COLON = t.TOKEN_DELIM_ARRAY = t.TOKEN_DELIM_OBJECT = t.createTokenizationSupport = void 0),
