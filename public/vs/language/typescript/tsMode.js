...
define("vs/language/typescript/workerManager", [
  ...
  define("vs/language/typescript/lib/lib.index", [
    "require",
    "exports"
  ], function(e, t) {
    "use strict";
...
define("vs/language/typescript/languageFeatures", [
  ...
  var s;
  function o(e, t, r) {
    if ((void 0 === r && (r = 0), "string" == typeof e)) return e;
    if (void 0 === e) return "";
    var n = "";
    if (r) {
      n += t;
  ...
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.RenameAdapter = t.CodeActionAdaptor = t.FormatOnTypeAdapter = t.FormatAdapter = t.FormatHelper = t.Kind = t.OutlineAdapter = t.ReferenceAdapter = t.DefinitionAdapter = t.OccurrencesAdapter = t.QuickInfoAdapter = t.SignatureHelpAdapter = t.SuggestAdapter = t.DiagnosticsAdapter = t.LibFiles = t.Adapter = t.flattenDiagnosticMessageText = void 0),
    (function(e) {
      (e[(e.None = 0)] = "None"),
        (e[(e.Block = 1)] = "Block"),
        (e[(e.Smart = 2)] = "Smart");
          ...
          if (e.getModeId() === n) {
            var t,
              ...
              s = e.onDidChangeContent(function() {
                clearTimeout(t), (t = setTimeout(r, 500));
              }),
              ...
              case 1:
                return (
                  ...
                  e.isDisposed()
                    ? [2]
                    : ((r = []),
                      (n = this._defaults.getDiagnosticsOptions()),
                      (s = n.noSyntaxValidation),
                      (o = n.noSemanticValidation),
                      (a = n.noSuggestionDiagnostics),
                      s || r.push(t.getSyntacticDiagnostics(e.uri.toString())),
                      o || r.push(t.getSemanticDiagnostics(e.uri.toString())),
                      a || r.push(t.getSuggestionDiagnostics(e.uri.toString())),
                      [4, Promise.all(r)])
                );
              case 2:
      ...
      (t.prototype._convertRelatedInformation = function(e, t) {
        ...
        return (
          t.forEach(function(t) {
            var s = e;
            if (t.file) {
              var a = i.Uri.parse(t.file.fileName);
  ...
  var p = (function(e) {
    ...
    return (
      ...
      (t.prototype.provideCompletionItems = function(e, r, n, s) {
        return __awaiter(this, void 0, void 0, function() {
          var n, s, o, a, l, u;
              ...
              case 2:
                return !(u = c.sent()) || e.isDisposed()
                  ...
                  : [
                      2,
                      {
                        suggestions: u.entries.map(function(n) {
                          var l,
                            u = s;
                          if (n.replacementSpan) {
                            var c = e.getPositionAt(n.replacementSpan.start),
                              d = e.getPositionAt(
                                n.replacementSpan.start +
                                  n.replacementSpan.length
                              );
                            u = new i.Range(
                              c.lineNumber,
                              c.column,
                          ...
                          return (
                            -1 !==
                              (null === (l = n.kindModifiers) || void 0 === l
                                ? void 0
          ...
          return __generator(this, function(l) {
            switch (l.label) {
              ...
              case 1:
                return [
                  4,
                  l.sent().getCompletionEntryDetails(n.toString(), s, r.label)
                ];
              case 2:
                return (o = l.sent())
                  ? [
        ...
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(c) {
            switch (c.label) {
              case 0:
                return (
                  (n = e.uri), (s = e.getOffsetAt(r)), [4, this._worker(n)]
                );
              case 1:
                return (
                  (o = c.sent()),
                  e.isDisposed()
                    ...
                    : [
                        4,
                        o.getSignatureHelpItems(n.toString(), s, {
                  ...
                  : ((u = {
                    ...
                    l.items.forEach(function(e) {
                      ...
                      (t.documentation = { value: a(e.documentation) }),
                        ...
                        e.parameters.forEach(function(r, n, i) {
                          var s = a(r.displayParts),
                            o = {
                              label: s,
                              documentation: { value: a(r.documentation) }
                            };
                          (t.label += s),
                            t.parameters.push(o),
                            n < i.length - 1 &&
        ...
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(c) {
            switch (c.label) {
              case 0:
                return (
                  (r = e.uri), (n = e.getOffsetAt(t)), [4, this._worker(r)]
                );
              case 1:
                return (
                  (i = c.sent()),
                  e.isDisposed()
                    ? [2]
                    : [4, i.getQuickInfoAtPosition(r.toString(), n)]
                );
              case 2:
            ...
            switch (l.label) {
              ...
              case 1:
                return (
                  ...
                  e.isDisposed()
                    ? [2]
                    : [4, s.getOccurrencesAtPosition(r.toString(), n)]
                );
              case 2:
  ...
  var m = (function(e) {
    ...
    return (
      ...
      (t.prototype.provideDefinition = function(e, t, n) {
        return __awaiter(this, void 0, void 0, function() {
          var n, s, o, a, l, u, c, d, p, g, f, b;
          return __generator(this, function(h) {
            switch (h.label) {
              case 0:
                return (
                  (n = e.uri), (s = e.getOffsetAt(t)), [4, this._worker(n)]
                );
              case 1:
                return (
                  (o = h.sent()),
                  e.isDisposed()
                    ? [2]
                    : [4, o.getDefinitionAtPosition(n.toString(), s)]
                );
              case 2:
              ...
              case 3:
                if ((h.sent(), e.isDisposed())) return [2];
                for (l = [], u = 0, c = a; u < c.length; u++)
                  if (
                    ((d = c[u]),
                    (p = i.Uri.parse(d.fileName)),
                    (g = this._libFiles.getOrCreateModel(p)))
                  )
                    l.push({
                      uri: p,
                    ...
                    (f = r.typescriptDefaults.getExtraLibs()[d.fileName])
                  )
                    return (
                      (b = i.editor.createModel(f.content, "typescript", p)),
                      [
                        2,
                        { uri: p, range: this._textSpanToRange(b, d.textSpan) }
                      ]
                    );
                return [2, l];
            }
  ...
  var _ = (function(e) {
    ...
    return (
      __extends(t, e),
      (t.prototype.provideReferences = function(e, t, r, n) {
        return __awaiter(this, void 0, void 0, function() {
          var r, n, s, o, a, l, u, c, d, p;
            ...
            switch (g.label) {
              ...
              case 1:
                return (
                  ...
                  e.isDisposed()
                    ? [2]
                    : [4, s.getReferencesAtPosition(r.toString(), n)]
                );
              case 2:
                return !(o = g.sent()) || e.isDisposed()
                  ? [2]
                  : [
                      4,
                      this._libFiles.fetchLibFilesIfNecessary(
              ...
              case 3:
                if ((g.sent(), e.isDisposed())) return [2];
                for (a = [], l = 0, u = o; l < u.length; l++)
                  (c = u[l]),
                    (d = i.Uri.parse(c.fileName)),
                    (p = this._libFiles.getOrCreateModel(d)) &&
                      a.push({
                        uri: d,
            ...
            switch (l.label) {
              ...
              case 1:
                return (
                  ...
                  e.isDisposed()
                    ? [2]
                    : [4, r.getNavigationBarItems(t.toString())]
                );
              case 2:
                return !(n = l.sent()) || e.isDisposed()
                  ? [2]
                  : ((s = function(t, r, n) {
                      var o = {
                        name: r.text,
                        ...
                        range: a._textSpanToRange(e, r.spans[0]),
                        selectionRange: a._textSpanToRange(e, r.spans[0]),
                        tags: []
                      };
                      if (
                        (n && (o.containerName = n),
                        r.childItems && r.childItems.length > 0)
                      )
                        for (var l = 0, u = r.childItems; l < u.length; l++) {
                          var c = u[l];
                          s(t, c, o.name);
                        }
                      t.push(o);
  ...
  (y[S.module] = i.languages.SymbolKind.Module),
    (y[S.class] = i.languages.SymbolKind.Class),
    (y[S.enum] = i.languages.SymbolKind.Enum),
    (y[S.interface] = i.languages.SymbolKind.Interface),
    (y[S.memberFunction] = i.languages.SymbolKind.Method),
    (y[S.memberVariable] = i.languages.SymbolKind.Property),
    (y[S.memberGetAccessor] = i.languages.SymbolKind.Property),
    (y[S.memberSetAccessor] = i.languages.SymbolKind.Property),
    (y[S.variable] = i.languages.SymbolKind.Variable),
    (y[S.const] = i.languages.SymbolKind.Variable),
    (y[S.localVariable] = i.languages.SymbolKind.Variable),
    (y[S.variable] = i.languages.SymbolKind.Variable),
    (y[S.function] = i.languages.SymbolKind.Function),
    (y[S.localFunction] = i.languages.SymbolKind.Function);
  var w = (function(e) {
    function t() {
      return (null !== e && e.apply(this, arguments)) || this;
    }
  ...
  var F = (function(e) {
    ...
    return (
      __extends(t, e),
      (t.prototype.provideDocumentRangeFormattingEdits = function(e, t, r, n) {
        return __awaiter(this, void 0, void 0, function() {
          var n,
            i,
            s,
  ...
  var k = (function(e) {
    ...
    return (
            ...
            switch (d.label) {
              ...
              case 1:
                return (
                  ...
                  e.isDisposed()
                    ? [2]
                    : [4, l.getCodeFixesAtPosition(n.toString(), i, s, a, o)]
                );
              case 2:
      ...
      (t.prototype._tsCodeFixActionToMonacoCodeAction = function(e, t, r) {
        for (var n = [], i = 0, s = r.changes; i < s.length; i++)
  ...
  var A = (function(e) {
    ...
    return (
      __extends(t, e),
      (t.prototype.provideRenameEdits = function(e, t, r, n) {
        return __awaiter(this, void 0, void 0, function() {
          var n, s, o, a, l, u, c, d, p, g, f, b;
          return __generator(this, function(h) {
            switch (h.label) {
              ...
              case 1:
                return (
                  ...
                  e.isDisposed()
                    ...
                    : [
                        4,
                        a.getRenameInfo(s, o, { allowRenameOfImportPath: !1 })
                      ]
                );
              case 2:
                ...
                return [4, a.findRenameLocations(s, o, !1, !1, !1)];
              case 3:
                if (!(u = h.sent()) || e.isDisposed()) return [2];
                for (c = [], d = 0, p = u; d < p.length; d++) {
                  if (
                    ((g = p[d]),
                    (f = i.Uri.parse(g.fileName)),
                    !(b = i.editor.getModel(f)))
                  )
  ...
  define("vs/language/typescript/tsMode", [
    ...
    function a(e, t) {
      var s = new r.WorkerManager(t, e),
        ...
        a = new n.LibFiles(o);
      return (
        i.languages.registerCompletionItemProvider(t, new n.SuggestAdapter(o)),
        i.languages.registerSignatureHelpProvider(
          t,
          new n.SignatureHelpAdapter(o)
        ),
        i.languages.registerHoverProvider(t, new n.QuickInfoAdapter(o)),
        i.languages.registerDocumentHighlightProvider(
          t,
          new n.OccurrencesAdapter(o)
        ),
        i.languages.registerDefinitionProvider(
          t,
          new n.DefinitionAdapter(a, o)
        ),
        i.languages.registerReferenceProvider(t, new n.ReferenceAdapter(a, o)),
        i.languages.registerDocumentSymbolProvider(t, new n.OutlineAdapter(o)),
        i.languages.registerDocumentRangeFormattingEditProvider(
          t,
          new n.FormatAdapter(o)
        ),
        i.languages.registerOnTypeFormattingEditProvider(
          t,
          new n.FormatOnTypeAdapter(o)
        ),
        i.languages.registerCodeActionProvider(t, new n.CodeActionAdaptor(o)),
        i.languages.registerRenameProvider(t, new n.RenameAdapter(o)),
        new n.DiagnosticsAdapter(a, e, t, o),
        o
      );
    }
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.getTypeScriptWorker = t.getJavaScriptWorker = t.setupJavaScript = t.setupTypeScript = void 0),
