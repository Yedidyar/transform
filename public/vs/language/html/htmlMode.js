...
define("vs/language/html/workerManager", [
  ...
  (function(e) {
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.isLetterOrDigit = t.repeat = t.commonPrefixLength = t.endsWith = t.startsWith = void 0),
                  ...
                  return a < o.length
                    ? ((l = o[a]),
                      (function(e) {
                        ...
                        (c = (function(e) {
                          return i.startsWith(e, "'") || i.startsWith(e, '"')
                            ? e.slice(1, -1)
                            : e;
                        })(e.getText(l.range)))
                      )
      ...
      return (
        ...
        (e.prototype.doesSupportMarkdown = function() {
          ...
          if (!l.isDefined(this.supportsMarkdown)) {
            if (!l.isDefined(this.lsOptions.clientCapabilities))
        ...
        return (
          ...
          (e.prototype.doesSupportMarkdown = function() {
            ...
            if (!r.isDefined(this.supportsMarkdown)) {
              if (!r.isDefined(this.lsOptions.clientCapabilities))
                return (this.supportsMarkdown = !0), this.supportsMarkdown;
              var a =
                null ===
                  (n =
...
!(function(e) {
  ...
  define("vs/language/html/languageFeatures", [
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.SelectionRangeAdapter = t.FoldingRangeAdapter = t.RenameAdapter = t.DocumentRangeFormattingEditProvider = t.DocumentFormattingEditProvider = t.DocumentLinkAdapter = t.DocumentSymbolAdapter = t.DocumentHighlightAdapter = t.HoverAdapter = t.CompletionAdapter = void 0);
    var l = (function() {
      function e(e) {
        this._worker = e;
      }
                    ...
                    return (
                      e.textEdit &&
                        ...
                        void 0 !== t.replace
                          ...
                          : (r.range = a(e.textEdit.range)),
                        (r.insertText = e.textEdit.newText)),
                      e.additionalTextEdits &&
                        (r.additionalTextEdits = e.additionalTextEdits.map(s)),
      ...
      return (
        (e.prototype.provideHover = function(e, t, n) {
          ...
          return this._worker(i)
            ...
            .then(function(e) {
              if (e) return { range: a(e.range), contents: d(e.contents) };
            });
        }),
        e
      );
            ...
            .then(function(e) {
              if (e)
                return e.map(function(e) {
                  return { range: a(e.range), kind: u(e.kind) };
                });
            });
        }),
        e
            ...
            .then(function(e) {
              return (function(e) {
                ...
                for (var n in e.changes)
                  for (
                    var r = i.Uri.parse(n), o = 0, s = e.changes[n];
                    o < s.length;
                    o++
                  ) {
                    var l = s[o];
                    t.push({
                      resource: r,
                      edit: { range: a(l.range), text: l.newText }
                    });
                  }
                return { edits: t };
              })(e);
          ...
          return this._worker(i)
            ...
            .then(function(e) {
              if (e)
                return e.map(function(e) {
                  for (var t = []; e; )
                    t.push({ range: a(e.range) }), (e = e.parent);
                  return t;
                });
            });
        }),
