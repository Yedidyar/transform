 ...
 *-----------------------------------------------------------*/ define("vs/editor/editor.main.nls.it", {
  ...
  "vs/editor/common/config/editorOptions": [
    ...
    "Controlla le dimensioni del carattere dei suggerimenti incorporati nell'Editor. Quando \xE8 impostato su `0`, viene usato il 90% del valore di `#editor.fontSize#`.",
  ...
  "vs/editor/contrib/find/findWidget": [
    ...
    "Sostituisci",
    "Sostituisci tutto",
    "Attiva/Disattiva modalit\xE0 sostituzione",
  ...
  "vs/editor/contrib/hover/markdownHoverParticipant": ["Caricamento..."],
  ...
  "vs/editor/contrib/unusualLineTerminators/unusualLineTerminators": [
    ...
    "Questo file contiene uno o pi\xF9 caratteri di terminazione di riga insoliti, ad esempio separatore di riga (LS) o separatore di paragrafo (PS).\r\n\r\n\xC8 consigliabile rimuoverli dal file. \xC8 possibile configurare questa opzione tramite `editor.unusualLineTerminators`.",
